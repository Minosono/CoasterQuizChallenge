...
// Ensure leaderboard and streaks are always visible
function updateLeaderboardAndStreaks() {
    const leaderboardSection = document.getElementById('leaderboard-section');
    const statsDisplay = document.getElementById('stats-display');

    leaderboardSection.classList.remove('hidden'); // Always show leaderboard
    statsDisplay.classList.remove('hidden'); // Always show streaks
}

// Call this function during initialization or mode changes
updateLeaderboardAndStreaks();
